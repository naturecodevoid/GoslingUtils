import math
from GoslingUtils.objects import Vector3
from GoslingUtils.objects import GoslingAgent as _GoslingAgent
...
def defaultThrottle(agent: _GoslingAgent, target_speed, direction=1.0):
